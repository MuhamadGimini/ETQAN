...
import { Modal, ConfirmationModal, PlusCircleIcon, DeleteIcon, EditIcon, PrintIcon, PdfIcon, ViewIcon, WhatsAppIcon, FormattedNumber, ChevronDownIcon, ArchiveIcon, WarningIcon, SwitchHorizontalIcon, ShoppingCartIcon, DownloadIcon } from './Shared';
...
const SalesInvoiceManagement: React.FC<SalesInvoiceManagementProps> = React.memo(({ 
    ...
    const handleExportExcel = () => {
        const dataToExport = filteredLog.map(inv => {
            ...
            return {
                'رقم الفاتورة': inv.id,
                'رقم الإذن': inv.permissionNumber || '',
                'التاريخ': inv.date,
        ...
        <div className="space-y-6">
            ...
            <Modal title="⚠️ تحذير: البيع بأقل من سعر الشراء" show={priceWarningModalOpen} onClose={() => setPriceWarningModalOpen(false)}>
                <div className="p-4">
                    ...
                    <div className="overflow-y-auto overflow-x-auto border border-gray-200 rounded-xl mb-6 max-h-[70vh]">
                        <table className="w-full text-right border-collapse">
                            <thead className="sticky top-0 z-10 bg-gray-50 dark:bg-gray-800 bg-gray-50">
                ...
                <div className="flex flex-col md:flex-row justify-between items-center mb-2 gap-4 cursor-pointer select-none" onClick={() => setIsLogVisible(!isLogVisible)}>
                    ...
                    {isLogVisible && (
                        <div className="flex items-center gap-4">
                            ...
                            <button onClick={(e) => { e.stopPropagation(); handleExportExcel(); }} className="bg-green-600 text-white p-2 rounded-lg shadow-sm hover:bg-green-700 transition-colors flex items-center justify-center" title="تصدير إلى إكسيل">
